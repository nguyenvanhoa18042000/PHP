...
<head>
	...
	<link rel="stylesheet" type="text/css" href="public/public_blog/css/css_login.css">
	<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	  <link rel="stylesheet" type="text/css" href="../../public/public_admin/css/my_css.css">
</head>
<body>
<div class="full-landing-img"></div>
<form action="?mod=auth&act=login_process" method="POST" id="form_login">
	...
	<div class="inputGroup inputGroup1">
		...
		<input required type="text" name="user_name" id="email" class="email" maxlength="256"/>
		<p class="helper helper1"></p>
		<span class="indicator"></span>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="password">Mật khẩu</label>
		<input required type="password" name="password" id="password" class="password" />
	</div>
	<p style="color: red;"><?php if (isset($_COOKIE['msg-go-login'])) {
		echo $_COOKIE['msg-go-login'];
	} ?></p>
	<div class="inputGroup inputGroup3">
		<button class="btn btn-block btn-process" type="submit" style="cursor: pointer;">Đăng nhập </button>
	</div>	
</form>
</body>
</html>
...
<script type="text/javascript" src="../../public/public_blog/js/js_login.js"></script>
<script src="http://www.jqueryscript.net/demo/jQuery-Plugin-For-Water-Ripple-Animation-ripples/js/jquery.ripples.js">
</script> 
<script type="text/javascript" src="../../public/public_blog/js/jquery.vide.min.js"></script>
