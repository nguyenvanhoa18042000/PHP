<?php 
	function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "nguyenvanzed18042000@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "zed18042000"; //Mật khẩu của gmail
        ...
        if(!$mail->Send()) {
          ...
          setcookie('msg_go_contact',"Đã gửi thư thành công!",time()+3);
          header("Location: ?mod=home&act=contact");
		  return true;
