...
<body>
	...
	?>
	<a style="text-align: right;  position: relative; float: right; right: 10%; margin-bottom: 2%;" class="btn btn-success" href="category_add.php"><i class="fa fa-plus" aria-hidden="true"></i> Add new category</a>
